...
class Menu extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->session->set_flashdata('flash','Menu Baru Berhasil Ditambahakan');
            redirect('menu');
        }
    }
    ...
    public function submenu()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->session->set_flashdata('flash','Sub Menu Baru Berhasil Ditambahakan');
    ...
    public function edit()
    {
        ...
        $this->Menu_model->edit_data($where, $data, 'user_sub_menu');
    ...
    public function edit_menu()
    {
        ...
        $this->Menu_model->edit_data($where, $data, 'user_menu');
