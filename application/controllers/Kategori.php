...
class Kategori extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->form_validation->set_rules('pelanggaran', 'Pelangaran', 'required');
        ...
        $this->db->insert('ketegori', $data);
        $this->session->set_flashdata('flash','Kategori Pelanggaran Berhasil Ditambahkan');
        redirect('kategori');
    }
    ...
    public function Pelanggaran()
    {
        ...
        $this->load->view('templates/sidebar', $data);
        $this->load->view('templates/topbar', $data);
        $this->load->view('kategori/pelanggaran', $data);
        $this->load->view('templates/footer');
   ...
   public function PelanggaranAdd()
    {
        ...
        $this->load->view('templates/sidebar', $data);
        $this->load->view('templates/topbar', $data);
        $this->load->view('kategori/pelanggaran-add', $data);
        $this->load->view('templates/footer');
        }else{
	...
	public function edit($pelanggaran_id = null)
{
    ...
    if ($this->form_validation->run() == false) {
        ...
        $this->load->view('templates/sidebar', $data);
        $this->load->view('templates/topbar', $data);
        $this->load->view('kategori/pelanggaran-edit', $data);
        $this->load->view('templates/footer');
    } else {
    ...
    public function ListPelanggaranPrint($pelanggaran_id = null){

        $data['title'] = 'Print List Pelanggaran';
        $data['user'] = $this->db->get_where('user', ['username' =>
        $this->session->userdata('username')])->row_array();

        $data['oneWeb'] = $this->admin_model->getOneWebsite($this->session->userdata('school_name'));
        $data['onepel'] = $this->admin_model->getOnePelanggaran($this->encrypt->decode($pelanggaran_id));  /*-- Load One Data Administrator --*/
       
        $this->load->view('kategori/listPelanggaranPrint', $data);
