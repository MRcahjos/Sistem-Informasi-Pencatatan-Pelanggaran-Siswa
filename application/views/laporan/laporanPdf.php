...
<body onload="window.print()">
	...
	<?php if($tipe == 'siswa') : ?>
			...
			<p style="text-align:center">
				<img alt="" src="<?= base_url('assets/img/');?>logo/smkmuhammadiyahkudus.png" style="float:left; height:100px; width:100px " />
				<img alt="" src="<?= base_url('assets/img/');?>logo/iso.png" style="float:right; height:100px; width:100px " />
				<span style="font-size:16px">
					<span style="font-family:Times New Roman,Times,serif">
					MAJELIS PENDIDIKAN DASAR DAN MENENGAH<br>
					PIMPINAN DAERAH MUHAMMADIYAH KABUPATEN KUDUS
					<br />
					<strong>SMK MUHAMMADIYAH KUDUS</strong>
					<br />
					<span style="font-size: 14px;">Alamat : Jl. Kudus - Jepara km. 3, Prambatan Lor, Kaliwungu, Kudus 59361</span>
					<br />
					<span style="font-size: 14px;">Telp. (0291) 441992 Fax (0291) 4248191, Email smkmuhikudus@gmail.com website: http://www.smkmuhkudus.sch.id</span>
					</span>
				</span>
				</p>
						...
						<table border="0" cellpadding="0" cellspacing="0" style="width:100%">
							<tbody>
								...
								<tr>
									...
									<td><span style="font-size:16px"><span style="font-family:Times New Roman,Times,serif"><?= $hasilOne->nama;?></span></span></td>
								</tr>
								<tr>
									<td style="width:170px"><span style="font-size:16px"><span style="font-family:Times New Roman,Times,serif">Kelas</span></span></td>
									<td><span style="font-size:16px"><span style="font-family:Times New Roman,Times,serif">:</span></span></td>
									<td><span style="font-size:16px"><span style="font-family:Times New Roman,Times,serif"><?= $hasilOne->nama_kls;?></span></span></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td><span style="font-size:16px"><span style="font-family:Times New Roman,Times,serif">:</span></span></td>
									<td><span style="font-size:16px"><span style="font-family:Times New Roman,Times,serif"><?= $hasilOne->alamat;?></span></span></td>
								</tr>
								<tr>
									...
									<td><span style="font-size:16px"><span style="font-family:Times New Roman,Times,serif">:</span></span></td>
									<td><span style="font-size:16px"><span style="font-family:Times New Roman,Times,serif"><?= $hasilOne->no_telp;?></span></span></td>
								</tr>
							</tbody>
						</table>
						&nbsp;
							...
							<table border="1" cellpadding="2" cellspacing="0" style="width:100%" >
								<tbody>
									...
									<tr>
										...
										<td style="text-align:left"><?= $all->pelanggaran;?></td>
										<td style="text-align:left"><?= $all->catatan ;?></td>
									...
									<tr>
										<td style="text-align:center; width:200px"><br />
											...
											<td style="width:200px">
												<p style="text-align:center"><span style="font-size:16px"><span style="font-family:Times New Roman,Times,serif">Kudus,<?=date('Y-m-d')?><br />
										...
										<tr>
											...
											<td>&nbsp;</td>
											<td style="text-align:center"><span style="font-size:16px"><span style="font-family:Times New Roman,Times,serif"><?= $hasilOne->nama?></span></span></td>
										</tr>
									</tbody>
								</table>
		...
		<?php if($tipe == 'kelas') : ?>
			...
			<p style="text-align:center"><img alt="" src="<?= base_url('assets/img/');?>logo/logo.png" style="float:left; height:100px; width:100px " />
				<span style="font-size:20px"><span style="font-family:Times New Roman,Times,serif">PEMERINTAH KABUPATEN KUDUS
					<img class="hidden" alt="" src="<?= base_url('assets/img/');?>logo/logo.png " style="float:right; height:100px; width:100px; " /><br />
					DINAS PENDIDIKAN PEMUDA DAN OLAHRAGA<br />
					<strong><?= $oneWeb->school_name ;?></strong><br />
					<span style="font-size: 16px;">Alamat : Jl. Kudus - Jepara No.KM.3</span><br />
					<span style="font-size: 14px;">Email : 	smkmuhikudus@gmail.com HP : (0291) 441992</span></span></span></p>
							...
							<table border="0" cellpadding="0" cellspacing="0" style="width:100%">
								<tbody>
									<tr>
										<td style="width:170px"><span style="font-size:16px"><span style="font-family:Times New Roman,Times,serif">Kelas</span></span></td>
										<td style="width:10px"><span style="font-size:16px"><span style="font-family:Times New Roman,Times,serif">:</span></span></td>
										<td><span style="font-size:16px"><span style="font-family:Times New Roman,Times,serif"><?= $hasilOne->kelas;?></span></span></td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td><span style="font-size:16px"><span style="font-family:Times New Roman,Times,serif">:</span></span></td>
										<td><span style="font-size:16px"><span style="font-family:Times New Roman,Times,serif"><?= $hasilOne->nama_wali;?></span></span></td>
									</tr>
								</tbody>
							</table>
							&nbsp;
							...
							<div style="text-align:justify">
								<table border="1" cellpadding="2" cellspacing="0" style="width:100%" >
									<tbody>
										...
										<tr>
											<td style="text-align:center"><?= $i ;?></td>
											<td style="text-align:left"><?= $all->nama;?></td>
											<td style="text-align:left"><?= $all->pelanggaran;?></td>
											<td style="text-align:left"><?= $all->catatan ;?></td>
											<td style="text-align:center"><?= date('d F Y', strtotime($all->reported_on)) ;?></td>
											<td style="text-align:center"><?= $all->point ;?></td>
