            ...
            <div class="container-fluid col-sm-8">
              ...
              <div class="card card-outline card-info">
                ...
                <div class="card-body">
                  ...
                  <!-- <form action="<?= base_url('siswa/PelanggaranAdd')?>" method="post"> -->
                  <?php echo form_open_multipart('siswa/PelanggaranAdd'); ?>
                    <div class="row ">
                    ...
                    <div class="form-group">
                      ...
                      <input type="hidden" name="nama_mhs" id="nama_mhs" value="" >
