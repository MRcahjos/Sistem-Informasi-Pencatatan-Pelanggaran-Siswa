        ...
        <table border="0" cellpadding="0" cellspacing="0" style="width:100%">
          <tbody>
            ...
            <tr>
              ...
              <td><span style="font-size:16px"><span style="font-family:Times New Roman,Times,serif"><?= $onepel->nama;?></span></span></td>
            </tr>
            <tr>
              <td style="width:170px"><span style="font-size:16px"><span style="font-family:Times New Roman,Times,serif">Kelas</span></span></td>
              <td><span style="font-size:16px"><span style="font-family:Times New Roman,Times,serif">:</span></span></td>
              <td><span style="font-size:16px"><span style="font-family:Times New Roman,Times,serif"><?= $onepel->nama_kls;?></span></span></td>
            </tr>
            <tr>
              ...
              <td><span style="font-size:16px"><span style="font-family:Times New Roman,Times,serif">:</span></span></td>
              <td><span style="font-size:16px"><span style="font-family:Times New Roman,Times,serif"><?= $onepel->parent_name;?></span></span></td>
            </tr>
            <tr>
              <td style="width:170px"><span style="font-size:16px"><span style="font-family:Times New Roman,Times,serif">Alamat</span></span></td>
              <td><span style="font-size:16px"><span style="font-family:Times New Roman,Times,serif">:</span></span></td>
              <td><span style="font-size:16px"><span style="font-family:Times New Roman,Times,serif"><?= $onepel->alamat;?></span></span></td>
            </tr>
            <tr>
              ...
              <td><span style="font-size:16px"><span style="font-family:Times New Roman,Times,serif">:</span></span></td>
              <td><span style="font-size:16px"><span style="font-family:Times New Roman,Times,serif"><?= $onepel->no_telp;?></span></span></td>
            </tr>
          </tbody>
        </table>
              ...
              <tr>
                <td style="text-align:center; width:200px"><br />
                  ...
                  <td style="width:200px">
                    <p style="text-align:center"><span style="font-size:16px"><span style="font-family:Times New Roman,Times,serif">Kudus,<?=date('d-m-Y')?><br />
                ...
                <tr>
                  <td style="text-align:center"><span style="font-size:16px"><span style="font-family:Times New Roman,Times,serif"><?= $onepel->parent_name?></span></span></td>
                  <td>&nbsp;</td>
                  <td style="text-align:center"><span style="font-size:16px"><span style="font-family:Times New Roman,Times,serif"><?= $onepel->nama?></span></span></td>
                </tr>
              </tbody>
            </table>
