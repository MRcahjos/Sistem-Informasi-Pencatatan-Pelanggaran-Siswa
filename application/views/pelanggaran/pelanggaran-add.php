            ...
            <div class="container-fluid col-sm-8">
              ...
              <div class="card card-outline card-info">
                <div class="card-header">
                  ...
                  <a class="btn btn-secondary btn-sm float-right" href="<?php echo base_url('pelanggaran/pelanggaran');?>">
                    <i class="fas fa-arrow-left"></i>&ensp;Back
                  </a>
                </div>
                <div class="card-body">
                <?php echo form_open_multipart('pelanggaran/PelanggaranAdd'); ?>
                  <!-- <form action="<?= base_url('pelanggaran/PelanggaranAdd')?>" method="post"> -->
                    <div class="row ">
